                                ...
                                <div class="card-body" style="text-align: left;">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <select required name="sport_id" class="form-control">
                                                <?php foreach ($sports as $sport) : ?>
                                        ...
                                        <div class="col">
                                            ...
                                            <select required name="terrain_id" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date_" required class="form-control">
                                    </div>

                                    <div class="row">
                                        <div class="col">
                                            <label class="required" for="field_rental_booking_time_picker_start">De</label>
                                            <select required name="hour_start" class="form-control">
                                        ...
                                        <div class="col">
                                            ...
                                            <select required name="hour_fin" class="form-control">
                                                <option value="00:00">00:00</option>
                                                <option value="01:00">01:00</option>
                                                <option value="02:00">02:00</option>
                                                <option value="03:00">03:00</option>
